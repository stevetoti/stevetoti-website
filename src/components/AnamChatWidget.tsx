  ...
  const handleSend = async (text: string) => {
    ...
    setTimeout(() => {
      const responses: Record<string, string> = {
        ...
        "consultation": "Great choice! You can book a free 30-minute discovery call with Stephen. Click here to schedule: https://cal.com/stevetoti\n\nOr send a message via the contact form!",
